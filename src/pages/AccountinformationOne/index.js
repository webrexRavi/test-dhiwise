...
const AccountinformationOnePage = () => {
    ...
    <>
      <Column className="bg-white_A700 flex flex-col font-worksans items-center justify-end mx-[auto] w-[100%]">
        <Column className="flex flex-col justify-start w-[100%]">
          ...
          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start max-w-[1080px] md:ml-[27px] ml-[auto] mr-[auto] sm:mt-[12px] md:mt-[16px] mt-[24px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
            <Column className="flex flex-col justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[30%]">
              <Text
              ...
              <Stack className="h-[589px] sm:mt-[12px] md:mt-[16px] mt-[24px] outline outline-[0.25px] outline-black_900_63 py-[14px] sm:py-[7px] md:py-[9px] relative w-[100%]">
                <div className="absolute bg-blue_A400_63 sm:h-[25px] md:h-[32px] h-[46px] top-[5%] w-[100%]"></div>
                <Column className="absolute flex flex-col inset-x-[0] justify-start sm:mx-[0] mx-[auto] sm:px-[0] sm:w-[100%] w-[90%]">
                  ...
                  <Column className="flex flex-col items-end justify-start mt-[11px] sm:mt-[5px] md:mt-[7px] sm:mx-[0] pb-[1px] pl-[1px] sm:px-[0] sm:w-[100%] w-[65%]">
                    <Text
            ...
            <Column className="flex flex-col justify-start md:ml-[41px] ml-[60px] sm:mt-[31px] md:mt-[40px] mt-[59px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[66%]">
              <Text
              ...
              <Column className="flex flex-col justify-start sm:mt-[11px] md:mt-[15px] mt-[22px] w-[100%]">
                <Column className="flex flex-col justify-start w-[100%]">
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between w-[100%]">
                    <FloatingInput
                      className="bg-transparent placeholder:bg-white_A700 border-0 font-normal placeholder:left-[16px] not-italic text-[16px] placeholder:text-bluegray_800 text-bluegray_800 placeholder:top-[0] top-[0] tracking-ls015000000596046448 w-[100%]"
                      type="password"
                      name="StateHoverIc"
                      labelClasses="bg-white_A700 left-[16px] top-[0] text-bluegray_800"
                      focusedClasses="translate-y-[16px] scale-[1]"
                      wrapperClasses="w-[47%] sm:w-[100%] sm:mx-[0] top-[0]"
                      labelText="Password"
                  ...
                  <Column className="flex flex-col justify-start sm:mt-[17px] md:mt-[22px] mt-[32px] sm:mx-[0] sm:px-[0] py-[1px] sm:w-[100%] w-[50%]">
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mx-[0] sm:px-[0] sm:w-[100%] w-[62%]">
                      <Img
                      ...
                      />
                      <Text
                        className="flex-grow sm:ml-[4px] md:ml-[6px] ml-[9px] not-italic text-bluegray_800 tracking-ls015000000596046448 md:tracking-ls1 sm:tracking-ls1"
                        variant="body5"
                      >
                        Password must be minimum 8
                      </Text>
                    </Row>
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[4px] md:mt-[6px] mt-[9px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[68%]">
                      <Img
                        src="images/img_info.svg"
                        className="flex-shrink-0 sm:h-[12px] md:h-[16px] h-[22px] max-w-[100%] sm:w-[11px] md:w-[15px] w-[22px]"
                        alt="info One"
                    ...
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end sm:mt-[4px] md:mt-[6px] mt-[9px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[72%]">
                      <Img
                        src="images/img_info.svg"
                        className="flex-shrink-0 sm:h-[12px] md:h-[16px] h-[22px] max-w-[100%] sm:w-[11px] md:w-[15px] w-[22px]"
                        alt="info Two"
                      />
                      <Text
                        className="flex-grow sm:ml-[4px] md:ml-[6px] ml-[9px] my-[4px] not-italic text-bluegray_800 tracking-ls015000000596046448 md:tracking-ls1 sm:tracking-ls1"
                        variant="body5"
                      >
                    ...
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[4px] md:mt-[6px] mt-[9px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[41%]">
                      <Img
                        src="images/img_info.svg"
                        className="flex-shrink-0 sm:h-[12px] md:h-[16px] h-[22px] max-w-[100%] sm:w-[11px] md:w-[15px] w-[22px]"
                        alt="info Four"
                ...
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[22px] md:mt-[28px] mt-[42px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[26%]">
                  <Text
                    className="font-medium text-red_400 uppercase w-[auto]"
                    variant="body3"
                  >
                    Cancel
                  </Text>
                  <Button
                    className="cursor-pointer font-medium min-w-[49%] sm:ml-[18px] md:ml-[23px] ml-[34px] text-[14px] text-center text-white_A700 uppercase w-[max-content]"
...
export default AccountinformationOnePage;
