...
const AccountinformationTwoPage = () => {
        ...
        <Column className="flex flex-col justify-start w-[100%]">
          <header className="w-[100%]">
            <Column className="flex flex-col justify-start max-w-[1440px] ml-[auto] mr-[auto] sm:pl-[15px] sm:pr-[15px] w-[100%]">
                        ...
                        <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:px-[0] w-[100%]">
                          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between sm:mx-[0] sm:px-[0] sm:w-[100%] w-[35%]">
                            <Column className="flex flex-col justify-start mt-[3px] sm:mx-[0] sm:px-[0] w-[10%] sm:w-[100%]">
                              <Text
                                className="font-medium text-blue_A400 w-[auto]"
                                variant="body2"
                              >
                                Home
                              </Text>
                              <div className="bg-blue_A400 h-[1px] mt-[3px] rounded-radius05 sm:w-[100%] w-[42%]"></div>
                            </Column>
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-end md:ml-[27px] ml-[40px] sm:mt-[12px] md:mt-[16px] mt-[24px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[9%]">
                <Img
                ...
                <Text
                  className="font-normal mb-[1px] sm:ml-[4px] md:ml-[5px] ml-[8px] sm:mt-[3px] md:mt-[4px] mt-[6px] not-italic text-blue_A400 w-[auto]"
                  variant="body3"
                >
                  My profile
                </Text>
          ...
          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start max-w-[1080px] md:ml-[27px] ml-[auto] mr-[auto] md:mt-[11px] mt-[16px] sm:mt-[8px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
            <Column className="flex flex-col justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[30%]">
              ...
              <Stack className="h-[589px] sm:mt-[12px] md:mt-[16px] mt-[24px] outline outline-[0.25px] outline-black_900_63 sm:pb-[218px] md:pb-[282px] pb-[410px] relative w-[100%]">
                <div className="absolute bg-blue_A400_63 sm:h-[25px] md:h-[32px] h-[46px] w-[100%]"></div>
                <Column className="absolute flex flex-col inset-x-[0] justify-start sm:mx-[0] mx-[auto] sm:px-[0] top-[2%] sm:w-[100%] w-[90%]">
                  <Column className="flex flex-col items-end justify-start sm:mx-[0] pb-[1px] pl-[1px] sm:px-[0] sm:w-[100%] w-[76%]">
                    <Text
            ...
            <Column className="flex flex-col justify-start md:ml-[41px] ml-[60px] sm:mt-[26px] md:mt-[34px] mt-[50px] sm:mx-[0] sm:pt-[4px] md:pt-[5px] pt-[8px] sm:px-[0] sm:w-[100%] w-[66%]">
              <Column className="flex flex-col justify-start w-[100%]">
                <Text
                  className="font-semibold text-gray_901 md:tracking-ls1 sm:tracking-ls1 tracking-ls24 uppercase w-[auto]"
                  as="h6"
                  variant="h6"
                >
                ...
                <Column className="flex flex-col items-center justify-start sm:mt-[12px] md:mt-[15px] mt-[23px] w-[100%]">
                  <Grid className="sm:gap-[28px] md:gap-[37px] gap-[54px] grid sm:grid-cols-1 grid-cols-2 min-h-[auto] w-[100%]">
                    <FloatingInput
                    ...
                    <FloatingInput
                      ...
                      defaultText="Mymail@company.com"
                    ></FloatingInput>
                  </Grid>
                </Column>
              </Column>
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[22px] md:mt-[28px] mt-[42px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[26%]">
                <Text
                  className="font-medium text-red_A700 uppercase w-[auto]"
                  variant="body3"
                >
                  Cancel
                </Text>
...
export default AccountinformationTwoPage;
